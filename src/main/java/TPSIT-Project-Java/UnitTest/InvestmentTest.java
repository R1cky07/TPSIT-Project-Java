...
class InvestmentTest {
    ...
    void testExecuteInvestment() {
        ...
        assertTrue(result >= 900.0 && result <= 1100.0, "Investment result should be within expected range");
    }

    @Test
    void testGetDuration() {
        assertEquals(3, investment.getDuration(), "Duration should be 3 months for short-term investment");
    }
