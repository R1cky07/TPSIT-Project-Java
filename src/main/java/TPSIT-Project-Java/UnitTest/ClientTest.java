...
class ClientTest {
    ...
    void testDepositMoney() {
        ...
        assertEquals(0.0, client.getAccountBalance(), "Account balance should remain 0.0 because there are no funds in the wallet");
        client.nonBankFunds = 200.0;
        client.depositMoney(100.0);
        assertEquals(100.0, client.getAccountBalance(), "Account balance should be 100.0 after deposit");
    ...
    void testWithdrawMoneySufficientBalance() {
        ...
        assertEquals(50.0, client.getAccountBalance(), "Account balance should be 50.0 after withdrawal");
        assertEquals(150.0, client.getNonBankFunds(), "Non-bank funds should be 150.0 after withdrawal");
    }
